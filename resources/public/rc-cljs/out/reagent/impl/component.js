...
reagent.impl.component.do_render = (function do_render(c){var _STAR_current_component_STAR_6626 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = c;
var f = (c["cljsRender"]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"f","f",-1640531425,null))))].join('')))})());var p = (c["props"]);var res = ((((c["componentFunction"]) == null))?f.call(null,c):(function (){var argv = (p["argv"]);var n = cljs.core.count.call(null,argv);var G__6627 = n;if(cljs.core._EQ_.call(null,5,G__6627))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3),cljs.core.nth.call(null,argv,4));
} else
{if(cljs.core._EQ_.call(null,4,G__6627))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3));
} else
{if(cljs.core._EQ_.call(null,3,G__6627))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2));
} else
{if(cljs.core._EQ_.call(null,2,G__6627))
{return f.call(null,cljs.core.nth.call(null,argv,1));
} else
{if(cljs.core._EQ_.call(null,1,G__6627))
{return f.call(null);
} else
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_6626;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__6629 = key;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",4147620643),G__6629))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",4103164189),G__6629))
{return (function (oldprops){var c = this;return f.call(null,c,(oldprops["argv"]));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUpdate","componentWillUpdate",2086388618),G__6629))
{return (function (nextprops){var c = this;return f.call(null,c,(nextprops["argv"]));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",3193956709),G__6629))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillReceiveProps","componentWillReceiveProps",2122862542),G__6629))
{return (function (props){var c = this;return f.call(null,c,(props["argv"]));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getInitialState","getInitialState",2219830677),G__6629))
{return (function (){var c = this;return reagent.impl.component.set_state.call(null,c,f.call(null,c));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getDefaultProps","getDefaultProps",1976256919),G__6629))
{if(false)
{return null;
} else
...
{return (function() { 
var G__6630__delegate = function (args){var c = this;return cljs.core.apply.call(null,f,c,args);
};
var G__6630 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__6630__delegate.call(this,args);};
G__6630.cljs$lang$maxFixedArity = 0;
G__6630.cljs$lang$applyTo = (function (arglist__6631){
var args = cljs.core.seq(arglist__6631);
return G__6630__delegate(args);
});
...
{var G__6633 = f;(G__6633["__reactDontBind"] = true);
return G__6633;
} else
{return f;
}
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__6635 = o;(G__6635[cljs.core.name.call(null,k)] = v);
return G__6635;
}),{},m);
});
...
return (function() { 
var G__6636__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
