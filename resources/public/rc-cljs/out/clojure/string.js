...
{var pred__6452 = cljs.core._EQ_;var expr__6453 = limit;if(cljs.core.truth_(pred__6452.call(null,1,expr__6453)))
...
var G__6455 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6456 = (limit__$1 - 1);
var G__6457 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6455;
limit__$1 = G__6456;
parts = G__6457;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6459 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6459))
{var replacement_6460 = temp__4090__auto___6459;buffer.append([cljs.core.str(replacement_6460)].join(''));
} else
{buffer.append(ch);
}
{
